                  ...
                  <div class="col-lg-12">
                    <div class="tabs tabs-primary">
                      <ul class="nav nav-tabs nav-justified ">
                        <li class="nav-item active  border border-dark"> <a class="nav-link" href="#product_tab" data-toggle="tab"><i data-feather="tag"></i>
                            <h4> Products Under AMC</h4>
                          </a> </li>
                        <li class="nav-item active border border-dark"> <a class="nav-link" href="#service_tab" data-toggle="tab"><i data-feather="settings"></i>
                            <h4> Service Schedule</h4>
                          </a> </li>
                        <li class="nav-item active border border-dark"> <a class="nav-link" href="#payment_tab" data-toggle="tab"><i data-feather="dollar-sign"></i>
                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      <div class="form-group"><button type="button" name="reset" value="Add new row" onclick="prodtotalval()" class="btn btn-warning add-row"><i data-feather="plus"></i> Add Item</button>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
