      ...
      <div class="row flex-grow">
        <div class="col-md-12 stretch-card">
          <div class="card card-custom">
            <div class="card-body">
              <h6 class="card-title">
                <h4>Issue Product & Service of AMC:</h4>
              </h6><br>
                  ...
                  <div class="col-lg-12">
                    <div class="tabs tabs-primary">
                      <ul class="nav nav-tabs nav-justified ">
                        <li class="nav-item active  border border-dark"> <a class="nav-link" href="#product_tab" data-toggle="tab"><i class="fas fa-tags"></i>
                            <h4> Products Under AMC</h4>
                          </a> </li>
                        <li class="nav-item active border border-dark"> <a class="nav-link" href="#service_tab" data-toggle="tab"><i class="fas fa-wrench"></i>
                            <h4> Service Schedule</h4>
                          </a> </li>
                        <li class="nav-item active border border-dark"> <a class="nav-link" href="#payment_tab" data-toggle="tab"><i class="fas fa-rupee-sign"></i>
                            ...
                            <div class="col-lg-12 " id="prodserialreload">
                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  <tr>
                                    <td>
                                      <div class="form-group " id="selectprodserial">
                                    ...
                                    <td>
                                      <div class="form-group"><button type="button" name="reset" value="Add new row" onclick="prodtotalval()" class="btn btn-warning add-row"><i class="fa fa-plus"></i> Add Item</button>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
