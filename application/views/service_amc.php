					...
					<div class="col-md-12 grid-margin stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="dataTableExample" class="table">
                                ...
                                <tbody>
                                <?php if(!empty($service_amc)) { foreach($service_amc as $user){?>
                                <tr>
                                <td><?php echo $user['sr_no'];  ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group d-flex" role="group">
                                            <a title="Quote AMC without Warranty" href="<?php echo base_url().'index.php/welcome/edit_service_amc'.$user['sr_no']?>" type="button" class="btn btn-primary" > <i class="" data-feather="edit"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                <?php } } else { ?>
