                ...
                <div class="modal-body">
                    ...
                    <form action="http://xlinkinfocom.com/amc-call-management-system/envatouser/API/validate.php" method="POST" class="form-horizontal">
                        ...
                        <div class="alert alert-success" role="alert">
                            <p>You are installing this application in <b><?php echo $referer; ?></b></p>
                            <p>How to get API Key ? <a target="_blank" href="http://xlinkinfocom.com/amc-call-management-system/#activate_application">Click Here to get details</a></p>
                        </div>
                </div>
