...
<div class="page-content">
            ...
            <div class="row flex-grow">
                <div class="col-md-12 stretch-card">
                    <section class="card card-custom">
                        <div class="card-body">
                        <h6 class="card-title">
                            <h4>Issue Service of AMC:</h4>
                        </h6>
                            <form method="post" action="<?php echo base_url() . 'index.php/welcome/service_amc'; ?>">
                                <div class="row">
                                    <div class="col-lg-5 my-2">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label class="control-label">AMC Code * </label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">New/Renew AMC ? * </label>
                                            ...
                                            <div class="form-group" id="ifYes" style="display: none;">
                                                ...
                                                <div class="col-sm-8">
                                                    <select data-plugin-selecttwo="" name="renew_amccode" id="renew_amccode" class="form-control populate placeholder select-hidden-accessible" data-plugin-options="{ &quot;placeholder&quot;: &quot;Select Expred AMC&quot;, &quot;allowClear&quot;: true }" data-select-id="renew_amccode" tabindex="-1" aria-hidden="true">
                                                        <option value="" data-select-id="2"></option>
                                                        <option value="AWMT-00238">AWMT-00238 - 2020-07-28</option>
                                                    </select>
                                                    <span class="select select-container select-container--bootstrap" dir="ltr" data-select-id="1" style="width: 325.656px;">
                                                        <span class="selection">
                                                            <span class="select-selection select-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select-renew_amccode-container">
                                                                <span class="select-selection__rendered" id="select-renew_amccode-container" role="textbox" aria-readonly="true">
                                                                    <span class="select-selection__placeholder">Select Expred AMC</span>
                                                                </span>
                                                                <span class="select-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                                            </span>
                                                        </span>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label class="control-label">Select Customer * </label>
                                                    <select data-plugin-select="" name="custcode" id="custcode" required="" class="form-control populate placeholder select-hidden-accessible" data-plugin-options="{ &quot;placeholder&quot;: &quot;Select Customer&quot;, &quot;allowClear&quot;: true }" data-select-id="custcode" tabindex="-1" aria-hidden="true">
                                                        <option value="" data-select-id="4"></option>
                                                        <option value="CUST00229">CUST00229 - GOURI APARTMENT</option>
                                                    </select>
                                                    <span class="select select-container select-container--bootstrap" dir="ltr" data-select-id="3" style="width: 325.656px;">
                                                        <span class="selection">
                                                            <span class="select-selection select-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select-custcode-container">
                                                                <span class="select-selection__rendered" id="select-custcode-container" role="textbox" aria-readonly="true"></span>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Select Quotation * </label>
                                                    <select data-plugin-selecttwo="" name="invoiceno" id="invoiceno" required="" class="form-control populate placeholder select-hidden-accessible" data-plugin-options="{ &quot;placeholder&quot;: &quot;Select Quotation&quot;, &quot;allowClear&quot;: true }" data-select-id="invoiceno" tabindex="-1" aria-hidden="true">
                                                        <option value="" data-select-id="8"></option>
                                                        <option value="NO-QUOTATION">No Quotation</option>
                                                    </select>
                                                    <span class="select select-container select-container--bootstrap" dir="ltr" data-select-id="7" style="width: 325.656px;">
    ...
    <script src="http://www.xlinkinfocom.com/amc-call-management-system/app/source/vendor/select/js/select.js"></script>
